...
The data originates from COVID-19 Tracking project and NYTimes. It contains information about the number of cases for 50 US states.
...
Since the data covers only the year 2020, we cannot draw conclusions about trends over the entire COVID-19 pandemic or determine whether these trends persisted after the pandemic.
Additionally, this analysis focused on the US population, and the results may not be generalizable to other countries or regions as spending behavior may vary significantly across cultures and societies and COVID-19 may have affected different countries differently. 
